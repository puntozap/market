...
class InvoicesController extends \TCG\Voyager\Http\Controllers\Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $product_id=[];
        $InvoicePurchaseClient=InvoicePurchaseClient::where("invoice_id",$Invoice->id)->orderBy("product_id","asc")->get();
        foreach($InvoicePurchaseClient as $invoicePurchase){
            $Product=Product::find($invoicePurchase->product_id);
            $invoicePurchase->product=$Product;
        }
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted',"Invoice","id","User","InvoicePurchaseClient"));
    }
